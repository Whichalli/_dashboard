                        ...
                        <a href="${0}-project-details.html">
                            <div class="previous-item hover-shape-border hover-shape-inner">
                                ...
                                <div class="previous-raise">
                                    <span>${amountRaised_} ENSC (${progress.toFixed(2) }%)</span>
                                    <div class="progress-inner">
                                        <div class="progress">
                                            <div class="progress-bar progress-bar-striped" role="progressbar" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100" style="width: ${progress.toFixed(2)}%"></div>
                                        </div>
                                    </div>
                                </div>
                                <span class="border-shadow shadow-1"></span>
